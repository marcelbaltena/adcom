    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('service-templates.store') }}" class="p-6">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <select name="service_type" 
                                ...
                                required>
                            <option value="fixed" {{ old('service_type') == 'fixed' ? 'selected' : '' }}>Vaste prijs</option>
                            <option value="hourly" {{ old('service_type') == 'hourly' ? 'selected' : '' }}>Uurtarief</option>
                            <option value="package" {{ old('service_type') == 'package' ? 'selected' : '' }}>Pakket</option>
                        </select>
                        @error('service_type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div id="priceFields" class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <!-- Base Price -->
                        <div id="basePriceField" style="display: none;">
                        ...
                        <!-- Estimated Hours -->
                        <div id="estimatedHoursField" style="display: none;">
