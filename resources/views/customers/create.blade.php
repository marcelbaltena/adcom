                    ...
                    <div class="mb-8">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="description" name="description" rows="3"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="Brief description of the customer...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 business-fields">
                            <div>
                                ...
                                <select id="size" name="size" 
                                    ...
                                    <option value="small" {{ old('size') === 'small' ? 'selected' : '' }}>Small (1-10 employees)</option>
                                    <option value="medium" {{ old('size') === 'medium' ? 'selected' : '' }}>Medium (11-50 employees)</option>
                                    <option value="large" {{ old('size') === 'large' ? 'selected' : '' }}>Large (51-250 employees)</option>
                                    <option value="enterprise" {{ old('size') === 'enterprise' ? 'selected' : '' }}>Enterprise (250+ employees)</option>
                                </select>
                            </div>
                        </div>
                    </div>
